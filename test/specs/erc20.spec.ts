...
describe('ERC20', () => {
  ...
  it('isWithdrawExited', async () => {
    const exitTxHash = '0xb005d8db45f33836c422ee18286fa8ebe49b4ec7b9930e673d85ecd081cc3b8e';
  ...
  it('withdrawExit return tx', async () => {
    const result: ITransactionRequestConfig = (await erc20Parent.withdrawExit(
      '0x1c20c41b9d97d1026aa456a21f13725df63edec1b1f43aacb180ebcc6340a2d3',
      {
        returnTransaction: true,
      }
    )) as any;
    expect(result.data).equal(exitData);
    const rootChainManager = await abiManager.getConfig('Main.POSContracts.RootChainManagerProxy');
    expect(result['to'].toLowerCase()).equal(rootChainManager.toLowerCase());
  ...
  it('withdrawExitFaster return tx', async () => {
    ...
    const result: ITransactionRequestConfig = (await erc20Parent.withdrawExitFaster(
      '0x1c20c41b9d97d1026aa456a21f13725df63edec1b1f43aacb180ebcc6340a2d3',
      {
        returnTransaction: true,
      }
