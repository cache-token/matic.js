...
const execute = async () => {
  ...
  await abiManager.setABI('FxCacheRootTunnel', 'pos', abi);
  const client = await getPOSClient();
  const erc20Token = client.erc20(pos.parent.erc20, true);

  const result = await erc20Token.withdrawExit('0x5242c6fc0b00505944ca456603bcc700798123f6b65996fa561793970a18b21c', {
    gasLimit: 799795,
  });
